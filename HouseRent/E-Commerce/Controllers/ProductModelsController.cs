...
namespace E_Commerce.Controllers
{
    public class ProductModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,ImageUrl,Categery,Details,Price,Rating")] HouseModel productModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,ImageUrl,Categery,Details,Price,Rating")] HouseModel productModel)
        {
        ...
        {
            var productModel = await _context.House.FindAsync(id);
            _context.House.Remove(productModel);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
